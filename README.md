...
evidence is distributed through the Zenodo record described in
...
was the external DOI assignment, which is completed through Zenodo.

## Citation and license

Citation metadata is in `CITATION.cff`. Code, generated data, documentation,
and newly rendered figures are licensed under GPL-3.0-or-later. See `LICENSE`.
